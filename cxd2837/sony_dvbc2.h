/*------------------------------------------------------------------------------
  ...
  Last Updated  : $Date:: 2012-10-15 12:04:40 #$
  File Revision : $Revision:: 6206 $
------------------------------------------------------------------------------*/
/**
 @file    sony_dvbc2.h
...
------------------------------------------------------------------------------*/
/**
 @brief Pratical maximum of Data Slices in DVB-C2 signal to cater for most 
        systems yet conserve memory
*/
#define SONY_DVBC2_DS_MAX           16

/**
 @brief Pratical maximum of PLP's in a single Data Slice to cater for most 
        systems yet conserve memory
*/
#define SONY_DVBC2_PLP_MAX          16
...
------------------------------------------------------------------------------*/
/**
 @brief L1 signalling notch data structure.
*/
...
/** 
 @brief L1 signalling information structure definition.
*/
typedef struct sony_dvbc2_l1_t {
    ...
    sony_dvbc2_l1_gi_t gi;                          /**< Guard interval enumaration of the signal. */
