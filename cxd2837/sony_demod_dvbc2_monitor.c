                                                 ...
                                                 uint32_t * pIFAGC)
{
    ...
    result = sony_demod_dvbt2_monitor_IFAGCOut(pDemod, pIFAGC);
                                                      ...
                                                      sony_demod_terr_cable_spectrum_sense_t * pSense)
{
    ...
    result = sony_demod_dvbt2_monitor_SpectrumSense(pDemod, pSense);
    if (result != SONY_RESULT_OK){
        SONY_TRACE_RETURN(result);
    }
                                                      ...
                                                      int32_t * pOffset)
{
    ...
    result = sony_demod_dvbt2_monitor_CarrierOffset(pDemod, pOffset);
    if (result != SONY_RESULT_OK){
        SONY_TRACE_RETURN(result);
    }
                                                   ...
                                                   uint32_t * pFER)
{
    ...
    result = sony_demod_dvbt2_monitor_PostBCHFER(pDemod, pFER);
    if (result != SONY_RESULT_OK){
        SONY_TRACE_RETURN(result);
    }
                                                          ...
                                                          uint32_t * pPEN)
{
    ...
    result = sony_demod_dvbt2_monitor_PacketErrorNumber(pDemod, pPEN);
    if (result != SONY_RESULT_OK){
        SONY_TRACE_RETURN(result);
    }
                                               ...
                                               uint32_t * pTsRateKbps)
{
    ...
    result = sony_demod_dvbt2_monitor_TsRate(pDemod, pTsRateKbps);
    if (result != SONY_RESULT_OK){
        SONY_TRACE_RETURN(result);
    }
                                                 ...
                                                 uint8_t * pUnlockDetected)
{
    ...
    result = sony_demod_dvbt2_monitor_SyncStat (pDemod, pSyncStat, pTSLockStat, pUnlockDetected);
    if (result != SONY_RESULT_OK){
        SONY_TRACE_RETURN(result);
    }
                                                       ...
                                                       int32_t * pPPM)
{
    ...
    result = sony_demod_dvbt2_monitor_SamplingOffset (pDemod, pPPM);
    if (result != SONY_RESULT_OK){
        SONY_TRACE_RETURN(result);
    }
                                            ...
                                            uint32_t * pPER)
{
    ...
    result = sony_demod_dvbt2_monitor_PER (pDemod, pPER);
    if (result != SONY_RESULT_OK) {
        SONY_TRACE_RETURN(result);
    }
