...
if(((TunMode==31)||(TunMode==34)||(TunMode==44)||(TunMode==45)||(TunMode==42)||(TunMode==27))&&(CXD2837_DemodType==0)){
...
//
    ...
    if ((pInteg->pTunerTerrCable) && (pInteg->pTunerTerrCable->Tune)) {
		...
		if((TunMode==37)||(TunMode==34)||(TunMode==31)||(TunMode==44)||(TunMode==45)||(TunMode==42)||(TunMode==27))
		{
...
//#ifndef SONY_DISABLE_I2C_REPEATER
if((TunMode==37)||(TunMode==31)||(TunMode==34)||(TunMode==44)||(TunMode==45)||(TunMode==42)||(TunMode==27))
...
if(TunMode==37)
{
       ...
       //         #endif
//printf("SONY_DEMOD_TUNER_OPTIMIZE_ASCOT2E_dvbc******************\n");
