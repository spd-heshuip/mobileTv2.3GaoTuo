/*------------------------------------------------------------------------------
  ...
  File Revision : 1.0.5.0
------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------
 Based on ASCOT2E application note 2.1.0
------------------------------------------------------------------------------*/
...
static const sony_ascot2e_adjust_param_t g_param_table[SONY_ASCOT2E_TV_SYSTEM_NUM] = {
    ...
    {AUTO, AUTO, 0x03, AUTO, 0x06, OFFSET(-3), OFFSET(0),  BW_1_7,0x0B, 0x00},/**< SONY_ASCOT2E_DTV_DVBT2_1_7(DVB-T2 1.7MHzBW) */
