/*------------------------------------------------------------------------------
  ...
  Last Updated  : $Date:: 2012-06-11 10:37:19 #$
  File Revision : $Revision:: 5517 $
------------------------------------------------------------------------------*/
/**
 @file    sony_integ.h
...
@note Passing NULL as pTunerSat or pLnbc will disable communication
      with the device without throwing an arguement error.
        ...
        - By default, the driver enables the RF level monitoring on the device, 
          call ::sony_demod_SetConfig with ::SONY_DEMOD_CONFIG_RFLVMON_ENABLE = 0
          to disable it, after calling ::sony_integ_InitializeS.
...
*/
#elif defined SONY_DEMOD_SUPPORT_DVBS_S2 /* Devices supporting Terrestrial or Cable and Satellite systems */
/**
 @brief Construct the driver.
...
@note Passing NULL as pTunerTerrCable, pTunerSat or pLnbc will disable communication
      with the device without throwing an arguement error.
        ...
        - By default, the driver enables the RF level monitoring on the device, 
          call ::sony_demod_SetConfig with ::SONY_DEMOD_CONFIG_RFLVMON_ENABLE = 0
          to disable it, after calling ::sony_integ_InitializeS or 
          ::sony_integ_InitializeT_C.
...
/**
 @brief Initialize the demodulator and satellite tuner.  After this 
        operation, the demodulator and tuner are in a low power state (demod 
        state = ::SONY_DEMOD_STATE_SLEEP_S) awaiting tune or scan commands.
...
/**
 @brief Put the demodulator and tuner devices into a low power state for DVB-S and 
        ...
        In ::SONY_DEMOD_STATE_SLEEP_S GPIO, demodulator configuration options and
        DiSEqC contol are available.  Calling this function from 
        ::SONY_DEMOD_STATE_SLEEP_T_C will reconfigure the demodulator for use with
