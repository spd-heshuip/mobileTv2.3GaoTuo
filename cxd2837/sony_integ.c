...
sony_result_t sony_integ_InitializeT_C (sony_integ_t * pInteg)
{
	...
	//printf("sony_demod_InitializeT_C err=%d\n",result);
    if (result != SONY_RESULT_OK) {
        SONY_TRACE_RETURN (result);
    }

//#ifndef SONY_DISABLE_I2C_REPEATER
if((TunMode==31)||(TunMode==34)||(TunMode==34)||(TunMode==37)||(TunMode==44)||(TunMode==45)||(TunMode==42)||(TunMode==27))
{
...
//#ifndef SONY_DISABLE_I2C_REPEATER
	if((TunMode==31)||(TunMode==37)||(TunMode==44)||(TunMode==45)||(TunMode==42)||(TunMode==27))
	{
...
//#ifndef SONY_DISABLE_I2C_REPEATER
if((TunMode==31)||(TunMode==34)||(TunMode==37)||(TunMode==44)||(TunMode==45)||(TunMode==42)||(TunMode==27))
