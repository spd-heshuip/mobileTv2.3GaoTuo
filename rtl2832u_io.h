...
#define deb_info(x) printf(x)
#define deb_xfer(x) printf(x)
#define deb_rc(x)   printf(x)
#define LEN_1_BYTE					1
#define LEN_2_BYTE					2
#define LEN_4_BYTE					4
...
#define DIBUSB_I2C_TIMEOUT				50000

#define SKEL_VENDOR_IN  (USB_ENDPOINT_IN|USB_TYPE_VENDOR)
#define SKEL_VENDOR_OUT (USB_ENDPOINT_OUT|USB_TYPE_VENDOR)
