...
extern void platform_wait(unsigned long nMinDelayTime);
extern int read_rtl2832_stdi2c(unsigned short dev_i2c_addr,unsigned char* data,unsigned short bytelength);
extern int write_rtl2832_stdi2c(unsigned short dev_i2c_addr,unsigned char*	 data,unsigned short bytelength);
extern int rtl2832_GPIO4_hw_reset();
