...
****************************************************************************/
 ATBM_I2CREADWRITE_STATUS I2CWrite(uint8 ui8I2CSlaveAddr, uint8 *ui8pData, int i32Length)
 {
 	int result=ATBM_I2CREADWRITE_OK;
   	result = write_rtl2832_stdi2c(ui8I2CSlaveAddr, ui8pData, i32Length);
    return result;

 }
	
 ATBM_I2CREADWRITE_STATUS I2CRead(uint8 ui8I2CSlaveAddr, uint8 *ui8pData, int i32Length)
 {
 	int result=ATBM_I2CREADWRITE_OK;
   	result = read_rtl2832_stdi2c(ui8I2CSlaveAddr, ui8pData, i32Length);
    return result;
 }
...
int ATBMPowerOnInit(void)
{
	...
	stCustomConfig.stTunerConfig.ui32IFFrequency        = 5100; //unit: KHz, according to tuner settings
	...
	stCustomConfig.stTsMode.ui8SPIClockConstantOutput   = TS_CLOCK_CONST_OUTPUT;//TS_CLOCK_VALID_OUTPUT;
	...
	stCustomConfig.ui32SampleClkFrequency               = 24000; //unit: KHz
//s	stCustomConfig.ui32SampleClkFrequency               = 30400; //unit: KHz
	//dvbc config
...
int ATBMChannelLockCheck(void)
{
	...
	uint32 check_times = 8; //default DTMB: 100ms + 6*360ms timeout 
...
uint32 ATBMFrameErrorRatio(void)
{
	...
	printf("DTMB frame error number ui8FrameError0 = %d,ui8FrameError1 = %d\n",ui8FrameError0,ui8FrameError1);
...
{    
	uint8 ui8ATBMChipID;
	uint8 u8ChipVersion, ui8ADCRfv,ui8AGCPol;
	Delayms(1);/*1 ms*/ 
...
//	ATBMWrite(0x08,0x01,0x16);  //Should be set as calibrated from ATBM_PPM_Test() function
	ATBMWrite(0x08,0x00,0xaf);  //Should be set as calibrated from ATBM_PPM_Test() function
	ATBMWrite(0x08,0x01,0x15);  //Should be set as calibrated from ATBM_PPM_Test() function
	//AGC Reserve
	//===================================================	
	ATBMRead(0x10,0xf7,&ui8AGCPol); 	
	ui8AGCPol |=0x02;
	ATBMWrite(0x10,0xf7,ui8AGCPol);
	//===================================================
/* 	add 
	ATBMWrite(0x0b, 0x03, 0x1e);
*/
...
int ATBM_PPM_Test(void)
{
	...
	{
		printf("Error PPM Test result, The result is not correct if not locked.\n");
